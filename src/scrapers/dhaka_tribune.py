...
class DhakaTribuneScraper(BaseScraper):
    """Scraper for Dhaka Tribune news website."""
    
    def __init__(self):
        """Initialize Dhaka Tribune scraper."""
        super().__init__(
    ...
    def _get_search_url(self, page: int) -> str:
        ...
        """
        if page == 1:
            return "https://www.dhakatribune.com/search?q=road+accident"
        else:
            return f"https://www.dhakatribune.com/search?q=road+accident&page={page}"
    ...
    def _normalize_url(self, href: str) -> str:
        """
        Normalize URL for Dhaka Tribune.
    ...
    def _is_article_link(self, href: str) -> bool:
        """
        Check if a link is likely an article link for Dhaka Tribune.
        ...
        """
        # Dhaka Tribune specific patterns
        article_patterns = [
            '/news/',
            '/article/',
            '/story/',
