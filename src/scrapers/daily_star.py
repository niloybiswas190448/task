...
class DailyStarScraper(BaseScraper):
    ...
    def _get_search_url(self, page: int) -> str:
        ...
        """
        if page == 1:
            return "https://www.thedailystar.net/search?q=road+accident"
        else:
            return f"https://www.thedailystar.net/search?q=road+accident&page={page}"
    ...
    def _is_article_link(self, href: str) -> bool:
        """
        Check if a link is likely an article link for Daily Star.
